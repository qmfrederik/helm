...
echo "deb [arch=amd64] https://packages.microsoft.com/repos/microsoft-ubuntu-xenial-prod xenial main" | sudo tee /etc/apt/sources.list.d/dotnetdev.list > /dev/null
sudo apt-get update
